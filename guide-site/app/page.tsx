  ...
  return (
    <div style={{ background: "#0A0A0F", minHeight: "100vh", color: "#F0F0F0" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "48px", flexWrap: "wrap" }}>
          ...
          <div style={{ flex: "1", minWidth: "280px" }}>
            ...
            <div style={{ display: "flex", gap: "12px", flexWrap: "wrap" }}>
              <a href="https://challenge-project-june-2-vlp9.vercel.app/" target="_blank" rel="noopener noreferrer" style={{ border: "1px solid #7C3AED", color: "#7C3AED", padding: "12px 24px", borderRadius: "8px", fontWeight: 600, textDecoration: "none", fontSize: "14px" }}>
                Free Cheat Sheet
              </a>
            </div>
            {/* Stats */}
      ...
      <section style={{ maxWidth: "680px", margin: "0 auto", padding: "80px 24px", textAlign: "center" }}>
        ...
        <a
          href="https://challenge-project-june-2-vlp9.vercel.app/"
          target="_blank"
